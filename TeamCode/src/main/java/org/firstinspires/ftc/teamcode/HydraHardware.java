...
// import com.qualcomm.robotcore.hardware.GoBildaPinpoint;
// 
...
//         angleServo = hardwareMap.get(Servo.class, "angleServoLeft");
//         
// 
...
//         I2cDeviceSynch i2cDevice = hardwareMap.i2cDeviceSynch.get("pinpoint");
//         pinpoint = new GoBildaPinpoint(i2cDevice);
// 
//         // Configure Pinpoint (adjust values based on your setup)
//         pinpoint.setEncoderResolution(GoBildaOdometryPods.goBILDA_4_BAR_POD); // Or custom value, e.g., 19.894 ticks per mm
//         pinpoint.setEncoderDirections(EncoderDirection.FORWARD, EncoderDirection.FORWARD);
//         pinpoint.setOffsets(-84.0, -168.0); // Example offsets in mm; adjust for your robot
// 
