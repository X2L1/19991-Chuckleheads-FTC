...
public class RunTeleOpRed extends ParallelCommandGroup {
    ...
    public RunTeleOpRed(Alliance alliance, HardwareMap hMap, Telemetry telemetry, GamepadEx driverController, GamepadEx gunnerController) {
        ...
        // 2. Build a PathChain from currentPose to ParkPose
            ...
            PathChain parkPath = follower.pathBuilder().addPath(
                            new BezierLine(
                                    ...
                                    new Pose(39.45230769230771, 33.23076923076923)
                            )
